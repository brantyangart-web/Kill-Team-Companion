...
export const GAG_MESSAGES = [
  ...
  "计划的一部分？奸奇默默在计划书里划掉了你的名字，并表示这波白给纯属意外。",
  "大不净者在小本本上又记了一笔：『今天收获了一只新鲜的纳垢灵原材料。』",
  "他倒下的惨叫声高亢而婉转，完美符合色孽噪音战士的选拔标准。",
  "『马格努斯没做错什么！』 —— 灵能反噬爆头的前一秒，他依然如此坚信着。",
  "基里曼默默翻开了《阿斯塔特圣典》，翻了半天也没找到教你如何优雅白给的章节。",
  "芬里斯的太空野狼发出了哀嚎，今天又少了一个能用来接飞盘的倒霉蛋。",
  "荷鲁斯默默退出了群聊，并表示当年的叛乱都没你这波白给来得震撼。",
  "莫塔里安叹了口气：『我的瘟疫坚韧（DR 4+）都救不了你的非酋体质。』",
  "安格隆体内的屠夫之钉在疯狂抽搐，因为看到你的白给操作，他比你还愤怒！"
];
